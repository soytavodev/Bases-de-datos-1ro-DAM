...
<html>
	<head>
      ...
      nav{background:pink;padding:20px;gap:20px;flex:1;
      display:flex;flex-direction:column;gap:20px;}
      nav a{background:white;color:pink;text-decoration:none;
      padding:10px;}
      main{padding:20px;flex:4;}
      table td{padding:10px;}
      table{border:2px solid pink;width:100%;}
      th{background:pink;color:white;padding:10px;}
    </style>
  </head>
  <body>
    <?php
